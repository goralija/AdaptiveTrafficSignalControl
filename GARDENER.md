...
- Maintained repository: `goralija/AdaptiveTrafficSignalControl`.
- Review and edit this draft before merging; merging makes these rules source truth.

## Protected Modules

- `auth/**` because authentication and authorization are sensitive.
- `permissions/**` because permission behavior is sensitive.
